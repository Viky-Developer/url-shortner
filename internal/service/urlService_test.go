...
type mockQuerier struct {
	...
	byCodeFn func(context.Context, string) (gen.Url, error)
	byIDFn   func(context.Context, int64) (gen.Url, error)
	...
	softFn   func(context.Context, int64) (gen.Url, error)
	hardFn   func(context.Context, int64) error
}
...
func (m *mockQuerier) GetURLByShortCode(ctx context.Context, code string) (gen.Url, error) {
	return m.byCodeFn(ctx, code)
}

func (m *mockQuerier) GetURLByID(ctx context.Context, id int64) (gen.Url, error) {
...
func (m *mockQuerier) SoftDeleteURL(ctx context.Context, id int64) (gen.Url, error) {
	return m.softFn(ctx, id)
}

func (m *mockQuerier) HardDeleteURL(ctx context.Context, id int64) error {
	return m.hardFn(ctx, id)
}
...
func TestCreateGeneratesShortCode(t *testing.T) {
	...
	svc := NewURLService(mock, "http://localhost:8080", testLog(t))

	resp, err := svc.Create(context.Background(), payload.CreateURLRequest{
...
func TestGetByShortCodeNotFound(t *testing.T) {
	mock := &mockQuerier{
		byCodeFn: func(_ context.Context, _ string) (gen.Url, error) {
...
func TestListPagination(t *testing.T) {
	...
	resp, err := svc.List(context.Background(), 3, 10)
	if err != nil {
		t.Fatalf("list: %v", err)
	}
...
func TestSoftDeleteSetsDeletedAt(t *testing.T) {
	...
	mock := &mockQuerier{
		softFn: func(_ context.Context, _ int64) (gen.Url, error) {
			return deleted, nil
		},
	}
	svc := NewURLService(mock, "http://localhost:8080", testLog(t))

	resp, err := svc.SoftDelete(context.Background(), 1)
	if err != nil {
